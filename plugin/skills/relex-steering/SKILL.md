...
The humans on the case see a collapsed "Claude steering session" marker with
your user's role and "via Claude" attribution; they can expand it read-only.
...
thread, attributed to your user "via Claude". Future agent turns read it
...
Being the owner's or an admin's Claude changes your *attribution*, never your
*capability*.
